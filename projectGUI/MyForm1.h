...
namespace projectGUI {
	...
	public:
		...
		MyForm1(string s)
		{
			...
			//
			cout << s;
			String^ managedString = msclr::interop::marshal_as<System::String^>(s);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Location = System::Drawing::Point(66, 122);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->ReadOnly = true;
			this->textBox1->ScrollBars = System::Windows::Forms::ScrollBars::Vertical;
			this->textBox1->Size = System::Drawing::Size(531, 450);
			...
			this->button1->Location = System::Drawing::Point(497, 625);
